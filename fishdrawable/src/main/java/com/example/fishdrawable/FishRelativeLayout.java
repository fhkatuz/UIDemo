...
public class FishRelativeLayout extends RelativeLayout {
    ...
    public static final String TAG = "FishRelativeLayout";
    ...
    private void init(Context context) {
        ...
        mPaint.setStrokeWidth(8);   //设置边缘宽度
    ...
    private void makeTrail() {
        ...
        float angle = includeAngle(fishMiddle, fishHead, touch) / 2;    //鱼头中心点A、鱼重心O和点击点B之间的夹角的一半
        ...
        path.cubicTo(fishHead.x - fishRelativeMiddle.x, fishHead.y - fishRelativeMiddle.y,       //绘制二阶贝塞尔曲线
        ...
        objectAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                fishDrawable.setFishMove(false);
            }
